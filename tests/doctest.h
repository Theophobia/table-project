...
// ======================================================================
//
// main.h - the lightest feature-rich C++ single-header testing framework for unit tests and TDD
//
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void report_query(const QueryData& in) override {
            if(opt.version) {
                ...
                s << Color::Cyan << "[main] " << Color::None << "listing all tests suites\n";
                separator_to_stream();
        ...
        void test_run_end(const TestRunStats& p) override {
            ...
            s << Color::Cyan << "[main] " << Color::None << "tests cases: " << std::setw(totwidth)
